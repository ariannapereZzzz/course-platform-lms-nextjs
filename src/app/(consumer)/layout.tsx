...
function Navbar() {
  ...
  <nav className="flex gap-4 container">
    <Link className="mr-auto text-lg hover:underline px-2 flex items-center" href="/">Web Dev Simplified</Link>
    <Suspense fallback={<div>Loading...</div>}>

    <SignedIn>
      <Link className="hover:bg-accent/10 flex items-center px-2" href="/">Admin</Link>
